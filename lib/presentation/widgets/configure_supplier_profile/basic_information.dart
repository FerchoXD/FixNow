            ...
            children: [
              CustomTextField(
                ...
                errorMessage: basicInfoState.isFormPosted
                    ...
                    : null,
                initialValue: authState.user!.name,
              ),
              const SizedBox(
                height: 10,
              ),
              CustomTextField(
                label: 'Apellido',
                onChanged:
                    ref.read(basicInfoProvider.notifier).onLastNameChange,
                errorMessage: basicInfoState.isFormPosted
                    ? basicInfoState.lastName.errorMessage
                    : null,
                initialValue: authState.user!.lastName,
              ),
              const SizedBox(
                height: 10,
              ),
              ...
              CustomTextField(
                ...
                onChanged:
                    ref.read(basicInfoProvider.notifier).onPhoneNumberChange,
                errorMessage: basicInfoState.isFormPosted
                    ? basicInfoState.phoneNumber.errorMessage
                    : null,
                initialValue: authState.user!.phoneNumber,
              ),
              const SizedBox(
                height: 10,
              ),
              CustomTextField(
                label: 'Ubicación',
                onChanged:
                    ref.read(basicInfoProvider.notifier).onLocationChanged,
                errorMessage: basicInfoState.isFormPosted
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                    ...
                    onPressed: basicInfoState.isPosting
                        ? null
                        : () {
                            ref
